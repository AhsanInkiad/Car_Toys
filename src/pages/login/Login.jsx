    ...
    return (
        <div className='flex py-20 '>
            <div className=' mx-auto Laform1'>
                ...
                <div className="-mt-6 Latitle mx-auto  text-center"> Or,<br /><span>Log in with Google :</span></div>

                <button onClick={handleGlogin} className="-mt-8 Lalogin-with mx-auto">
                ...
                <div className="-mt-6 font-semibold text-[#666] mx-auto   text-center"> <br /><span className='text-sm'>Do not have an account? : <Link to='/register'> <u className=' hover:text-blue-500 text-md font-bold'>Reigster</u></Link> </span></div>
