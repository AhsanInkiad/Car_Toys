...
const NotFound = () => {
    return (
        <div>
            <div className='Vbody'>
                <div>
                    <svg className='Lsvg' width="1123" height="837" viewBox="0 0 1123 837" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="Ltext">
                    <h1 className='Lh1'>404 Error</h1>
                    <h2>Couldn't launch :(</h2>
                    <h3>Page Not Found - lets take you <Link to='/'><button className='btn btn-outline btn-warning'>BACK</button> </Link> </h3>
                </div>
            </div>
